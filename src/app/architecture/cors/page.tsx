...
const CorsSimulator = dynamic(
  () => import("../_components/cors-simulator").then(m => m.CorsSimulator),
...
export default function CorsPage() {
  return (
    <div className="max-w-4xl relative">
      <div className="absolute -top-10 -left-10 w-72 h-72 bg-gradient-to-br from-purple-500/10 via-violet-500/10 to-fuchsia-500/10 rounded-full blur-3xl pointer-events-none" />
      <div className="mb-10">
